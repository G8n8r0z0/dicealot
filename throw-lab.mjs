...
const BATTLE_TUNE_DEFAULTS = {
  world: { gravity: -55, restitution: 0.3, friction: 0.6 },
  body: {
    mass: 1, linearDamping: 0.05, angularDamping: 0.15, sleepTime: 0.3, sleepSpeed: 0.05,
    throwMin: 4, throwMax: 9,
  },
  sling: {
    maxPullWorld: 12.5, clickEpsMul: 0.02, pickYOffset: 0.55,
    impulseHMin: 1.85, impulseHMax: 11.2, impulseYMin: 1.15, impulseYMax: 4.35,
  },
  viz: { halfAngle: 0.38, rInner: 12, rSpan: 292, segments: 4 },
  spawn: { minSpacingMul: 1.18, stackYStepMul: 1.12, jitterMul: 0.32 },
  rollPlayer: { spawnYOffset: 0.95, planeJitter: 0.55, impulseYMul: 0.34, impulseCrossMul: 0.32, mainImpulse: 1.02 },
  rollBot: { spawnYOffset: 5.5, planeJitter: 0.55, impulseYMul: 0.4, impulseCrossMul: 0.28, mainImpulse: 0.95 },
