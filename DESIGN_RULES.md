...
## 8. Age Rating (PEGI 12)
- Content must comply with PEGI 12 - graphic, non-realistic violence, sexual innuendo, or mild bad language.
- **Prohibited:** realistic violence, detailed gore, profanity, jump scares, graphic nudity.
- Conflict must be presented in softened or abstract form (defeated enemies dissolve into particles, run away, die without explicit details etc.).
